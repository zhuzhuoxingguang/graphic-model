...
// const SubstationsFeeders = () => import('@/views/Relation/SubstationFeeder')
    ...
    return (
      <Layout style={{ minHeight: '100vh' }}>
        ...
        >
          <div className='logo'>
            {
              isCollapse ? null : <strong>配电模型校验系统 </strong>
            }
          </div>
          <NavMenu />
        </Sider>
        <Layout>
          ...
          <Footer style={{ textAlign: 'center', paddingTop: 0 }}>Copyright  2018 国网江苏省电力有限公司苏州供电分公司</Footer>
        </Layout>
      </Layout>
    )
  }
...
export default connect(mapStateToProps, { collapseNavMenu })(LayoutView)
