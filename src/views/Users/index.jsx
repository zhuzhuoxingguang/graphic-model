          ...
          <Form {...formItemLayout}>
            <Form.Item label="姓名">
              {getFieldDecorator(
                "username",
                config
              )(<Input allowClear size="large" autoComplete="off" placeholder="请输入用户名" />)}
            </Form.Item>
            <Form.Item label="账号">
              {getFieldDecorator(
                "account",
                configAccount
              )(<Input allowClear size="large" autoComplete="off" placeholder="请输入账号" />)}
            </Form.Item>
            <Form.Item label="电话" extra="初始密码为手机号码后6位">
              {getFieldDecorator("phone", {
                rules: [{ required: true, pattern: regMobile, message: "国内手机号码" }]
              })(
                <Input allowClear maxLength={11} size="large" autoComplete="off" placeholder="请输入手机号码" />
              )}
            </Form.Item>
          </Form>
        </DialogForm>
